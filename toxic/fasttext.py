...
submission.drop("comment_text", axis=1, inline=True)
submission[["toxic", "severe_toxic", "obscene", "threat", "insult", "identity_hate"]] = x_pred / 1.4
submission.to_csv("submission_bn_fasttext_train.csv", index=False)